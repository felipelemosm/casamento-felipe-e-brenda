    ...
    return (
      <section className="section">
        ...
        <p className="section-sub">
          {form.presenca === 'sim'
            ? `Que alegria, ${form.nome.split(' ')[0]}! Presença confirmada — nos vemos no dia 6 de setembro de 2026.`
  ...
  return (
    <section className="section">
      ...
      <p className="section-sub">
        ...
        até <strong>6 de agosto de 2026</strong>.
      </p>

      <p className="rsvp-reminder">
        💡 Antes de confirmar, não deixe de conferir as{' '}
        <Link to="/informacoes">Informações Importantes</Link> — lá estão as orientações de
        traje, horários e o que saber sobre o domingo em Pitangui.
      </p>
